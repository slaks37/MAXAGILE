...
export function CertificateModal({
  ...
  const [studentName, setStudentName] = useState(progress.studentName || 'Siswa MaxAgile');
  ...
  const handleSaveName = () => {
    onUpdateName(studentName.trim() || 'Siswa MaxAgile');
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3 border-b border-slate-100 pb-4 dark:border-slate-800">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Selamat! Anda telah menyelesaikan 100% materi kursus ini.
            </p>
          </div>
